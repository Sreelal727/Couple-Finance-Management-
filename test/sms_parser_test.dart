...
void main() {
  ...
  group('SmsParser ignores', () {
    ...
    test('future debit', () {
      expect(
        SmsParser.parse('AD-SBIINB', 'Rs 1499 will be debited from A/c X1234 on 10-09-25 for Netflix AutoPay'),
        isNull,
      );
    });
    test('failed', () {
      expect(
        SmsParser.parse('VM-HDFCBK', 'Your UPI txn of Rs 500 to Zomato has failed. Amount will be reversed.'),
        isNull,
      );
    });
